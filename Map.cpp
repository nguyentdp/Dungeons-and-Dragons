 ...
 * if user inputs u and if its not the top row of the map
 *      Move the player up by one row
 * if user inputs d and if its not the bottom row of the map
 *      Move the player down by one row
 * if user inputs l and if its not the leftmost column
 *      Move the player left by one column
 * if user inputs r and if its not the rightmost column
